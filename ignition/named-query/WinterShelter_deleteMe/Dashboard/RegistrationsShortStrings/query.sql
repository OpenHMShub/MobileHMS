--- WinterShelter/Dashboard/RegistrationsShortStrings --- 
...
SELECT
    ...
    CASE 
    	...
    	ELSE Night_s_of_the_Week_Hosting END AS 'Night',
    Days_To_Host,
    Number_of_Days,
    Number_of_Guests,
    Phone_Number_we_can_use_to_reach_you_during_evening_hours AS 'Evening Phone',
    CASE 
    	...
    	ELSE Gender_of_Guests END AS 'Gender',
    ...
    Can_you_accommodate_a_guest_who_uses_a_wheelchair AS "Wheelchair_Access",
    Is_a_designated_outdoor_smoking_area_provided AS 'Designated Smoking Area?',
    We_are_open_to_hosting_families_with_children AS 'Families',
